 ...
 * @author khushbu
 */
public class ManageOrganizationBloodBankJPanel extends javax.swing.JPanel {

    private OrganizationDirectory directory;
    private JPanel userProcessContainer;

    /**
     * Creates new form ManageOrganizationBloodBankJPanel
     */
    public ManageOrganizationBloodBankJPanel(JPanel userProcessContainer, OrganizationDirectory directory) {
        initComponents();
    ...
    private void populateCombo() {
        ...
        for (NewOrganization.OrganizationType type : NewOrganization.OrganizationType.values()) {
            if (type.getValue().equals(NewOrganization.OrganizationType.BloodBank.getValue())) {

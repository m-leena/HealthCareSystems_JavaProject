 ...
 * @author khushbu
 */
public class ManageOrganizationPharmaJPanel extends javax.swing.JPanel {

    private OrganizationDirectory directory;
    private JPanel userProcessContainer;

    /**
     * Creates new form ManageOrganizationPharmaJPanel
     */
    public ManageOrganizationPharmaJPanel(JPanel userProcessContainer, OrganizationDirectory directory) {
        initComponents();
    ...
    private void populateCombo() {
        ...
        for (NewOrganization.OrganizationType type : NewOrganization.OrganizationType.values()) {
            if (type.getValue().equals(NewOrganization.OrganizationType.Pharmacy.getValue())) {

...
import UserInterface.Ambulance.AmbulanceWokAreaJPanel;
...
public class AmbulanceRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer,UserAccount account,EcoSystem system,Enterprise enterprise,Network network,NewOrganization organization,DB4OUtil dB4OUtil) {
        return new AmbulanceWokAreaJPanel(userProcessContainer,account,system,enterprise,network,organization,dB4OUtil);
    }

...
import UserInterface.PharmacyStore.PharmacyStoresWorkAreaJPanel;
...
public class PharmacyRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer,UserAccount account,EcoSystem system,Enterprise enterprise,Network network,NewOrganization organization,DB4OUtil dB4OUtil) {
        return new PharmacyStoresWorkAreaJPanel(userProcessContainer,account,system,enterprise,network,organization,dB4OUtil);
    }
